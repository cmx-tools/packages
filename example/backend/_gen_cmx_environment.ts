import type { CmxEnvironment } from "@cmx-tools/contracts";
import type { CmxNode as CmxToolsContractsCmxnode } from "@cmx-tools/contracts";
...
type CmxEnvironmentExports = {
  default: CmxToolsContractsCmxnode;
