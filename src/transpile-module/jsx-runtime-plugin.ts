...
const JSX_RUNTIME_CONTENTS = [
  ...
  "const runtimeNodeMarkerKey = Symbol.for('cmx.runtime-node-marker');",
  "const externalRefs = new WeakMap();",
  "function childrenSlotsForNode(hasChildren, rawChildren) {",
  ...
  "  const node = { kind };",
  "  Object.defineProperty(node, runtimeNodeMarkerKey, {",
  "    configurable: false,",
  "    enumerable: false,",
  "    writable: false,",
  "    value: true,",
  ...
  "  const nodeChildren = childrenSlotsForNode(hasChildren, rawChildren);",
  "  const { children: _ignoredChildren, ...rest } = inputProps;",
  "  if (type === Fragment) return createNode('fragment', undefined, undefined, nodeChildren);",
  "  if (typeof type === 'string') return createNode('element', type, rest, nodeChildren);",
  ...
  "      );",
  "    }",
  "    const componentProps = hasChildren ? { ...rest, children: rawChildren } : rest;",
